...
int main() {
	string ImageName1 = "C:\\Users\\DylanSu\\Desktop\\12.jpg";
	string ImageName2 = "C:\\Users\\DylanSu\\Desktop\\3.jpg";
...
//单手针刺法1中的间隔帧数较远的两帧图像直接不相同的数据位为2位
//单手针刺法2中，12.jpg与76.jpg的不相同数据位为7位
//单手针刺法1和2的3.jpg与12.jpg的不相同数据位为30位
//要针对所得到的的轮廓进行尝试，将轮廓的单张图片的哈希值得到之后再进行比对。